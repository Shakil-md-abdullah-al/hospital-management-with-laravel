                ...
                <div class="d-flex justify-content-end" style="margin-top: -25px;">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('order-Lab')}}">Cash on Delivery</a>
                ...
                <table id="datatablesSimple" id="datatablesSimple" class="custom-table">
                    ...
                    @foreach($cart as $product)
                        <tr>
                            ...
                            <td style="width: 10%;">{{$product->test_name}}</td>
                            <td class="d-flex">
                                <div class="btn-group">
                                    {{--                                    <a href="{{route('products.edit',$product->id)}}" class="btn btn-primary">Edit</a>--}}
                                    <form action="{{ route('lab.destroy', $product->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        @if($product)
