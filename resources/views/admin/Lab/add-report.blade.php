        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    @endif
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Tests</h3></div>
                    <div class="card-body">
                        <form action="{{route('lab.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        ...
                                        <label for="doctorname">Test Name</label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputPassword" value="{{old('room')}}" name="room" type="number" placeholder="Tagline" required/>
                            ...
                            <div class="mt-4 mb-0">
                                <input type="submit" class="btn btn-outline-success text-center" value="Add Test">
                            </div>
                        </form>
                    </div>
                </div>
